    ...
    <div className="space-y-8 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-8 bg-zinc-900/50 border border-white/5 rounded-3xl text-center relative">
          ...
          <div className="text-xs text-white/40">Relative to city average</div>
      ...
      <div className="p-8 bg-zinc-900/50 border border-white/5 rounded-3xl">
        ...
        <p className="text-white/60 leading-relaxed text-sm">
          In your chosen city, your search criteria covers <span className="text-white font-medium">{Math.round(actualDenominator).toLocaleString()}</span> people. 
